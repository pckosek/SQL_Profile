...
app.get('/update_profile', function(req, res){
    ...
    // THE RIGHT WAY
    var sql = 'INSERT INTO profile(id, nickname) VALUES (0,?) ON DUPLICATE KEY UPDATE nickname = VALUES(nickname);'

    // THE WORST THING YOU COULD DO
    // var sql = 'INSERT INTO profile(id, nickname) VALUES (0,"'+nickname+'") ON DUPLICATE KEY UPDATE nickname = VALUES(nickname);'

    
    pool.query(sql, [nickname], function(error, results, fields){
